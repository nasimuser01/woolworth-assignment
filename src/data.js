export const data = [
    {
        ...
        description:
            'A low carb twist on the Greek classic, using cauliflower rice',
        tag: ['Greek', 'Vegetarian'],
        ...
        step: [
            {
                description:
                    'In a large frying pan cook the cauliflower rice and the onion with butter and the concentrated chicken stock until the cauliflower rice starts drying a bit and the onion becomes translucent (if not using frozen cauliflower rice you may need to cook the onion before adding the cauliflower rice). Do not add butter to the pan first, you can just cook it all together.',
            },
            {
                description:
                    'Move the mixture away from the center of the pan and pour some olive oil in the center. When it heats up, add the chopped garlic..',
            },
            {
                description:
                    'After the garlic becomes a little fragrant, mix it all together and add the spinach. Mix well and keep stirring until the spinach defrosts.',
            },
            {
                description:
                    'Once the spinach defrosts, add the spring onion, the chopped feta, and the dill (if using), and sprinkle with a generous amount of nutritional yeast. Stir well and salt to taste.',
            },
            {
                description:
                    'Add the lemon juice, give it a good stir and serve!',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        step: [
            {
                description:
                    'Beat all ingredients together really well in a blender.',
            },
            {
                description:
...

    {
        ...
        step: [
            ...
            {
                description:
                    'Bake at 215C/420F for 15 minutes or until golden brown.',
            },
            {
                description:
    ...
    },
    {
        ...
        step: [
            ...
            {
                description:
                    'Add garlic to the mushrooms and stir until fragrant.',
            },
            {
                description:
    ...
    },
    {
        ...
        step: [
            ...
            {
                description:
                    "Once you've poured all wine, add cloves and bay leaves.",
            },
            {
                description:
